package io.github.jasonmomanyi.legiontube.ui.screens.subscriptions
...
import io.github.jasonmomanyi.legiontube.data.local.VideoHistoryEntry
...
import io.github.jasonmomanyi.legiontube.data.model.Channel
...
class SubscriptionsViewModel : ViewModel() {
    ...
    private lateinit var cacheDao: io.github.jasonmomanyi.legiontube.data.local.dao.CacheDao
    ...
    private suspend fun fetchAndCacheSubscriptionFeed(
        ...
        try {
            ...
            io.github.jasonmomanyi.legiontube.data.innertube.RssSubscriptionService.fetchSubscriptionVideos(
...
private fun io.github.jasonmomanyi.legiontube.data.local.entity.SubscriptionFeedEntity.toVideo() = Video(
    id = videoId,
    title = title,
...
private fun Video.toSubscriptionFeedEntity(
    cachedAtMillis: Long
) = io.github.jasonmomanyi.legiontube.data.local.entity.SubscriptionFeedEntity(
    videoId = id,
    title = title,
    channelName = channelName,
    channelId = channelId,
