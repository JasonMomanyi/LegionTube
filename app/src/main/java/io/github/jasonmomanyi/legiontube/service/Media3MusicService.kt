package io.github.jasonmomanyi.legiontube.service
...
import io.github.jasonmomanyi.legiontube.data.model.ParametricEQ
import io.github.jasonmomanyi.legiontube.player.audio.CustomEqualizerAudioProcessor
...
import io.github.jasonmomanyi.legiontube.data.download.DownloadUtil
import io.github.jasonmomanyi.legiontube.extensions.setOffloadEnabled
import io.github.jasonmomanyi.legiontube.utils.MusicPlayerUtils
import io.github.jasonmomanyi.legiontube.utils.NetworkConnectivityObserver
...
class Media3MusicService : MediaLibraryService() {
    ...
    override fun onCreate() {
        ...
        serviceScope.launch {
            io.github.jasonmomanyi.legiontube.player.EnhancedMusicPlayerManager.isLiked.collectLatest { 
                updateNotification()
            }
        }
                    ...
                    if (!videoId.isNullOrBlank() && !title.isNullOrBlank() && !artist.isNullOrBlank()) {
                        serviceScope.launch(Dispatchers.IO) {
                            try {
                                ...
                                val helper = io.github.jasonmomanyi.legiontube.data.lyrics.LyricsHelper()
    ...
    private fun performAggressiveCacheClear(mediaId: String) {
        ...
        try {
            io.github.jasonmomanyi.legiontube.player.EnhancedMusicPlayerManager.invalidateResolvedStream(mediaId)
        } catch (e: Exception) {
    ...
    private fun updateNotification() {
        ...
        val isLiked = io.github.jasonmomanyi.legiontube.player.EnhancedMusicPlayerManager.isLiked.value
        ...
        override fun onCustomCommand(
            ...
            args: Bundle
             ...
             if (customCommand.customAction == ACTION_TOGGLE_LIKE) {
                 io.github.jasonmomanyi.legiontube.player.EnhancedMusicPlayerManager.emitToggleLikeEvent()
