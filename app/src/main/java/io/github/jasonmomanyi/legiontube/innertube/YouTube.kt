package io.github.jasonmomanyi.legiontube.innertube

import io.github.jasonmomanyi.legiontube.innertube.models.AccountInfo
...
import io.github.jasonmomanyi.legiontube.innertube.models.BrowseEndpoint
import io.github.jasonmomanyi.legiontube.innertube.models.GridRenderer
import io.github.jasonmomanyi.legiontube.innertube.models.MediaInfo
...
import io.github.jasonmomanyi.legiontube.innertube.models.MusicCarouselShelfRenderer
...
import io.github.jasonmomanyi.legiontube.innertube.models.SearchSuggestions
import io.github.jasonmomanyi.legiontube.innertube.models.Run
import io.github.jasonmomanyi.legiontube.innertube.models.Runs
import io.github.jasonmomanyi.legiontube.innertube.models.SongItem
import io.github.jasonmomanyi.legiontube.innertube.models.WatchEndpoint
import io.github.jasonmomanyi.legiontube.innertube.models.WatchEndpoint.WatchEndpointMusicSupportedConfigs.WatchEndpointMusicConfig.Companion.MUSIC_VIDEO_TYPE_ATV
import io.github.jasonmomanyi.legiontube.innertube.models.YouTubeClient
import io.github.jasonmomanyi.legiontube.innertube.models.YouTubeClient.Companion.WEB
import io.github.jasonmomanyi.legiontube.innertube.models.YouTubeClient.Companion.WEB_REMIX
import io.github.jasonmomanyi.legiontube.innertube.models.YouTubeLocale
import io.github.jasonmomanyi.legiontube.innertube.models.getContinuation
import io.github.jasonmomanyi.legiontube.innertube.models.getItems
import io.github.jasonmomanyi.legiontube.innertube.models.oddElements
import io.github.jasonmomanyi.legiontube.innertube.models.response.AccountMenuResponse
import io.github.jasonmomanyi.legiontube.innertube.models.response.BrowseResponse
import io.github.jasonmomanyi.legiontube.innertube.models.response.ChannelVideosResponse
import io.github.jasonmomanyi.legiontube.innertube.models.response.CreatePlaylistResponse
import io.github.jasonmomanyi.legiontube.innertube.models.response.EditPlaylistResponse
import io.github.jasonmomanyi.legiontube.innertube.models.response.FeedbackResponse
import io.github.jasonmomanyi.legiontube.innertube.models.response.GetQueueResponse
import io.github.jasonmomanyi.legiontube.innertube.models.response.GetSearchSuggestionsResponse
import io.github.jasonmomanyi.legiontube.innertube.models.response.GetTranscriptResponse
import io.github.jasonmomanyi.legiontube.innertube.models.response.ImageUploadResponse
import io.github.jasonmomanyi.legiontube.innertube.models.response.NextResponse
import io.github.jasonmomanyi.legiontube.innertube.models.response.PlayerResponse
import io.github.jasonmomanyi.legiontube.innertube.models.response.SearchResponse
import io.github.jasonmomanyi.legiontube.innertube.pages.AlbumPage
import io.github.jasonmomanyi.legiontube.innertube.pages.ArtistItemsContinuationPage
import io.github.jasonmomanyi.legiontube.innertube.pages.ArtistItemsPage
import io.github.jasonmomanyi.legiontube.innertube.pages.ArtistPage
import io.github.jasonmomanyi.legiontube.innertube.pages.ChartsPage
import io.github.jasonmomanyi.legiontube.innertube.pages.BrowseResult
import io.github.jasonmomanyi.legiontube.innertube.pages.ExplorePage
import io.github.jasonmomanyi.legiontube.innertube.pages.HistoryPage
import io.github.jasonmomanyi.legiontube.innertube.pages.HomePage
import io.github.jasonmomanyi.legiontube.innertube.pages.LibraryContinuationPage
import io.github.jasonmomanyi.legiontube.innertube.pages.LibraryPage
import io.github.jasonmomanyi.legiontube.innertube.pages.MoodAndGenres
import io.github.jasonmomanyi.legiontube.innertube.pages.NewReleaseAlbumPage
import io.github.jasonmomanyi.legiontube.innertube.pages.NextPage
import io.github.jasonmomanyi.legiontube.innertube.pages.NextResult
import io.github.jasonmomanyi.legiontube.innertube.pages.PlaylistContinuationPage
import io.github.jasonmomanyi.legiontube.innertube.pages.PlaylistPage
import io.github.jasonmomanyi.legiontube.innertube.pages.RelatedPage
import io.github.jasonmomanyi.legiontube.innertube.pages.SearchPage
import io.github.jasonmomanyi.legiontube.innertube.pages.SearchResult
import io.github.jasonmomanyi.legiontube.innertube.pages.SearchSuggestionPage
import io.github.jasonmomanyi.legiontube.innertube.pages.SearchSummary
import io.github.jasonmomanyi.legiontube.innertube.pages.SearchSummaryPage
import io.github.jasonmomanyi.legiontube.innertube.pages.ShortsPage
import io.github.jasonmomanyi.legiontube.innertube.pages.toShortsPage
...
object YouTube {
    ...
    data class ChannelVideoSearchResult(
        val videos: List<io.github.jasonmomanyi.legiontube.data.model.Video>,
    ...
    suspend fun channelSearch(
        ...
        val response = lenientJson.decodeFromString<io.github.jasonmomanyi.legiontube.innertube.models.response.ChannelSearchResponse>(rawBody)
    ...
    suspend fun channelSearchContinuation(
        ...
        val videos = mutableListOf<io.github.jasonmomanyi.legiontube.data.model.Video>()
    ...
    private fun parseLockupViewModel(
        ...
        channelThumbnailUrl: String,
        isLive: Boolean,
    ): io.github.jasonmomanyi.legiontube.data.model.Video? {
        ...
        return io.github.jasonmomanyi.legiontube.data.model.Video(
            id = videoId,
            title = title,
    ...
    private fun parseChannelSearchResponse(
        response: io.github.jasonmomanyi.legiontube.innertube.models.response.ChannelSearchResponse,
        channelId: String,
        channelName: String,
        channelThumbnailUrl: String,
    ): ChannelVideoSearchResult {
    ...
    private fun parseVideoRenderer(
        r: io.github.jasonmomanyi.legiontube.innertube.models.response.ChannelSearchResponse.VideoRenderer,
        channelId: String,
        channelName: String,
        channelThumbnailUrl: String,
    ): io.github.jasonmomanyi.legiontube.data.model.Video? {
    ...
    suspend fun album(browseId: String, withSongs: Boolean = true): Result<AlbumPage> = runCatching {
        ...
        if (browseId.contains("FEmusic_library_privately_owned_release_detail")) {
            ...
            val albumItem = AlbumItem(
                ...
                explicit = response.header.musicDetailHeaderRenderer.subtitleBadges?.any { it.musicInlineBadgeRenderer?.icon?.iconType == "MUSIC_EXPLICIT_BADGE" } == true,
            )
            ...
            val albumItem = AlbumItem(
                ...
                explicit = response.contents.twoColumnBrowseResultsRenderer.tabs.firstOrNull()?.tabRenderer?.content?.sectionListRenderer?.contents?.firstOrNull()?.musicResponsiveHeaderRenderer?.subtitleBadges?.any { it.musicInlineBadgeRenderer?.icon?.iconType == "MUSIC_EXPLICIT_BADGE" } == true,
            )
            return@runCatching AlbumPage(
                album = albumItem,
                ...
                renderer.flexColumns.size >= 3 && renderer.playlistItemData?.videoId != null -> {
                    ...
                    val album = secondColumn.runs?.firstNotNullOfOrNull { run ->
                        run.navigationEndpoint?.browseEndpoint?.browseId?.takeIf { 
                            ...
                            io.github.jasonmomanyi.legiontube.innertube.models.Album(name = run.text, id = id)
                        }
                    }
        ...
        return try {
            when {
                renderer.isSong -> {
                    ...
                    val artists = mutableListOf<Artist>()
                    var album: io.github.jasonmomanyi.legiontube.innertube.models.Album? = null
                    
                    subtitle.forEach { run ->
                        run.navigationEndpoint?.browseEndpoint?.browseId?.let { id ->
                            if (id.startsWith("MPRE") || id.startsWith("OLAK")) {
                                album = io.github.jasonmomanyi.legiontube.innertube.models.Album(
                                    name = run.text,
                                    id = id
                                )
                            } else {
    ...
    fun getNewPipeStreamUrls(videoId: String): List<Pair<Int, String>> {
        return io.github.jasonmomanyi.legiontube.innertube.pages.NewPipeExtractor.newPipePlayer(videoId)
    }
