...
- 🤖 **LEGION Engine** — Enhanced local privacy-respecting recommendations engine running 100% on-device
...
| | Light | Dark |
|---|---|---|
| **Primary** | 🔴 `#D32F2F` | 🔴 `#FF5252` |
| **Secondary** | 🔵 `#1A237E` | 🔵 `#536DFE` |
| **Tertiary** | 🟣 `#651FFF` | 🟣 `#7C4DFF` |
| **Background** | ⬜ `#FFF8F8` | ⬛ `#0A0A0A` |
...
LegionTube is [Free Software](https://en.wikipedia.org/wiki/Free_software): You can use, study, share and modify it at your will. The app can be redistributed and/or modified under the terms of the
