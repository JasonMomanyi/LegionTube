package io.github.jasonmomanyi.legiontube.data.newmusic
...
import io.github.jasonmomanyi.legiontube.innertube.YouTube.SearchFilter
...
import io.github.jasonmomanyi.legiontube.ui.screens.music.PlaylistDetails
import io.github.jasonmomanyi.legiontube.ui.screens.music.MusicPlaylist
import io.github.jasonmomanyi.legiontube.ui.screens.music.ArtistDetails
...
object InnertubeMusicService {
    ...
    suspend fun fetchMoodAndGenres(): List<io.github.jasonmomanyi.legiontube.innertube.pages.MoodAndGenres> = withContext(Dispatchers.IO) {
        try {
    ...
    suspend fun searchPlaylists(query: String): List<MusicPlaylist> = withContext(Dispatchers.IO) {
        try {
            ...
            result.getOrNull()?.items?.filterIsInstance<io.github.jasonmomanyi.legiontube.innertube.models.PlaylistItem>()
    ...
    suspend fun getRelatedMusic(videoId: String, audioOnly: Boolean = false): List<MusicTrack> = withContext(Dispatchers.IO) {
        try {
            val nextResult = YouTube.next(io.github.jasonmomanyi.legiontube.innertube.models.WatchEndpoint(videoId = videoId)).getOrNull()
     ...
     */
    suspend fun fetchArtistDetails(channelId: String): io.github.jasonmomanyi.legiontube.ui.screens.music.ArtistDetails? = withContext(Dispatchers.IO) {
        try {
            ...
            var albums: List<io.github.jasonmomanyi.legiontube.ui.screens.music.MusicPlaylist> = emptyList()
            var singles: List<io.github.jasonmomanyi.legiontube.ui.screens.music.MusicPlaylist> = emptyList()
            var videos: List<MusicTrack> = emptyList()
            var relatedArtists: List<io.github.jasonmomanyi.legiontube.ui.screens.music.ArtistDetails> = emptyList()
            var featuredOn: List<io.github.jasonmomanyi.legiontube.ui.screens.music.MusicPlaylist> = emptyList()
            ...
            page.sections.forEach { section ->
                ...
                when {
                    ...
                    title.contains("albums") -> {
                        albums = section.items.filterIsInstance<io.github.jasonmomanyi.legiontube.innertube.models.AlbumItem>().map { convertAlbumToPlaylist(it) }
                    ...
                    title.contains("singles") || title.contains("ep") -> {
                        singles = section.items.filterIsInstance<io.github.jasonmomanyi.legiontube.innertube.models.AlbumItem>().map { convertAlbumToPlaylist(it) }
                    ...
                    title.contains("fans might also like") || title.contains("related") -> {
                        relatedArtists = section.items.filterIsInstance<io.github.jasonmomanyi.legiontube.innertube.models.ArtistItem>().map { convertArtistItemToDetails(it) }
                    }
                    title.contains("featured on") || title.contains("playlists") -> {
                        featuredOn = section.items.filterIsInstance<io.github.jasonmomanyi.legiontube.innertube.models.PlaylistItem>().map { convertPlaylistToMusicPlaylist(it) }
                    }
                }
            }
            
            io.github.jasonmomanyi.legiontube.ui.screens.music.ArtistDetails(
    ...
    suspend fun fetchArtistItems(browseId: String, params: String?): List<MusicPlaylist> = withContext(Dispatchers.IO) {
        try {
            val result = YouTube.artistItems(io.github.jasonmomanyi.legiontube.innertube.models.BrowseEndpoint(browseId, params))
            result.getOrNull()?.items?.filterIsInstance<io.github.jasonmomanyi.legiontube.innertube.models.AlbumItem>()
    ...
    private fun convertAlbumToPlaylist(item: io.github.jasonmomanyi.legiontube.innertube.models.AlbumItem): io.github.jasonmomanyi.legiontube.ui.screens.music.MusicPlaylist {
        return io.github.jasonmomanyi.legiontube.ui.screens.music.MusicPlaylist(
            id = item.browseId ?: "",
            title = item.title ?: "",
    ...
    private fun convertPlaylistToMusicPlaylist(item: io.github.jasonmomanyi.legiontube.innertube.models.PlaylistItem): io.github.jasonmomanyi.legiontube.ui.screens.music.MusicPlaylist {
        return io.github.jasonmomanyi.legiontube.ui.screens.music.MusicPlaylist(
            id = item.id ?: "",
            title = item.title ?: "",
            thumbnailUrl = item.thumbnail ?: "",
    ...
    private fun convertArtistItemToDetails(item: io.github.jasonmomanyi.legiontube.innertube.models.ArtistItem): io.github.jasonmomanyi.legiontube.ui.screens.music.ArtistDetails {
        return io.github.jasonmomanyi.legiontube.ui.screens.music.ArtistDetails(
            name = item.title ?: "",
            channelId = item.id ?: "",
            thumbnailUrl = item.thumbnail ?: "",
            subscriberCount = 0L,
        ...
        return when (item) {
            is SongItem -> {
                MusicTrack(
                    ...
                    artists = item.artists.map { io.github.jasonmomanyi.legiontube.ui.screens.music.MusicArtist(it.name, it.id) },
    ...
    suspend fun getMediaInfo(videoId: String): io.github.jasonmomanyi.legiontube.innertube.models.MediaInfo? = withContext(Dispatchers.IO) {
         try {
