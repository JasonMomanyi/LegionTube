...
import com.github.legiontube.api.PipedMediaServiceRepository
...
import com.github.legiontube.databinding.SimpleOptionsRecyclerBinding
import com.github.legiontube.helpers.PreferenceHelper
import com.github.legiontube.ui.adapters.InstancesAdapter
import com.github.legiontube.ui.base.BasePreferenceFragment
import com.github.legiontube.ui.dialogs.CreateCustomInstanceDialog
import com.github.legiontube.ui.dialogs.CustomInstancesListDialog
import com.github.legiontube.ui.dialogs.DeleteAccountDialog
import com.github.legiontube.ui.dialogs.LoginDialog
import com.github.legiontube.ui.dialogs.LogoutDialog
    ...
    private fun showInstanceSelectionDialog(preference: ListPreference) {
        ...
        MaterialAlertDialogBuilder(requireContext())
            ...
            .setNegativeButton("Sync") { _, _ ->
                customInstancesModel.fetchAndSyncPublicInstances { success ->
                    lifecycleScope.launch(Dispatchers.Main) {
                        if (success) {
                            Toast.makeText(context, "Instances synced!", Toast.LENGTH_SHORT).show()
                        } else {
