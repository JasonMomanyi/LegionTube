...
fun PlayerDialogsContainer(
    ...
    if (showSettingsSurface && renderSettingsMenu) {
        SettingsMenuDialog(
            ...
            onCastClick = {
                io.github.jasonmomanyi.legiontube.player.dlna.DlnaCastManager.startDiscovery(context)
                screenState.showSettingsMenu = false
            ...
            onPipClick = {
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O &&
                    ...
                    screenState.showSettingsMenu = false
                    io.github.jasonmomanyi.legiontube.player.PictureInPictureHelper.requestPlayerPipMode(
