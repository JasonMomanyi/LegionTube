...
class FlowNeuroEngineTest {
    ...
    fun `extractFeatures identifies topics from title`() {
        ...
        val method = LegionTubeNeuroEngine::class.java.getDeclaredMethod("extractFeatures", Video::class.java)
        method.isAccessible = true
        val vector = method.invoke(LegionTubeNeuroEngine, video) as ContentVector
    ...
    fun `extractFeatures calculates duration score correctly`() {
        ...
        val longVector = method.invoke(LegionTubeNeuroEngine, longVideo) as ContentVector
        val shortVector = method.invoke(LegionTubeNeuroEngine, shortVideo) as ContentVector
