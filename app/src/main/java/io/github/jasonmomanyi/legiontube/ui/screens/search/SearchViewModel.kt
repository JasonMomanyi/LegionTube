...
import io.github.jasonmomanyi.legiontube.data.paging.SearchPagingSource
...
class SearchViewModel(
    ...
    fun hasActiveFilters(filters: SearchFilter?): Boolean {
        ...
        return filters.contentType != ContentType.ALL
                || filters.duration != io.github.jasonmomanyi.legiontube.data.local.Duration.ANY
                || filters.uploadDate != io.github.jasonmomanyi.legiontube.data.local.UploadDate.ANY
                || filters.sortType != io.github.jasonmomanyi.legiontube.data.local.SortType.RELEVANCE
    }
