 ...
 *
 * This recommendation algorithm (LegionTubeNeuroEngine) is the intellectual property
 ...
 */
class LegionTubeNeuroEngine(private val appContext: Context) {

    companion object {
        private const val TAG = "LegionTubeNeuroEngine"
        ...
        @Volatile
        private var instance: LegionTubeNeuroEngine? = null

        fun getInstance(context: Context): LegionTubeNeuroEngine {
            return instance ?: synchronized(this) {
                instance ?: LegionTubeNeuroEngine(context.applicationContext).also {
                    instance = it
                }
            }
        }

        private fun requireInstance(): LegionTubeNeuroEngine =
            instance ?: error("LegionTubeNeuroEngine not initialized. Call initialize(context) first.")
