package io.github.jasonmomanyi.legiontube.ui.screens.channel
...
import io.github.jasonmomanyi.legiontube.data.paging.ChannelVideosPagingSource
import io.github.jasonmomanyi.legiontube.data.paging.ChannelPlaylistsPagingSource
...
class ChannelViewModel : ViewModel() {
    ...
    private val _playlistsPagingFlow = MutableStateFlow<Flow<PagingData<io.github.jasonmomanyi.legiontube.data.model.Playlist>>?>(null)
    val playlistsPagingFlow: StateFlow<Flow<PagingData<io.github.jasonmomanyi.legiontube.data.model.Playlist>>?> = _playlistsPagingFlow.asStateFlow()
    ...
    fun searchInChannel(query: String) {
        ...
        viewModelScope.launch(PerformanceDispatcher.networkIO) {
            ...
            try {
                ...
                val result = io.github.jasonmomanyi.legiontube.innertube.YouTube.channelSearch(
                    channelId = channelId,
    ...
    fun loadMoreSearchResults() {
        ...
        viewModelScope.launch(PerformanceDispatcher.networkIO) {
            ...
            try {
                ...
                val result = io.github.jasonmomanyi.legiontube.innertube.YouTube.channelSearchContinuation(
                    channelId = channelId,
                    channelName = channelInfo.name,
                    channelThumbnailUrl = channelThumbnail,
    ...
    private fun StreamInfoItem.toChannelVideo(channelInfo: ChannelInfo): Video {
        ...
        val displayUploadDate = textualDate
            ?: io.github.jasonmomanyi.legiontube.utils.formatTimeAgo(uploadDate?.offsetDateTime()?.toString())
