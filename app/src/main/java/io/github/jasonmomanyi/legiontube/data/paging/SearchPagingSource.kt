package io.github.jasonmomanyi.legiontube.data.paging

import android.util.Log
import androidx.paging.PagingSource
import androidx.paging.PagingState
import io.github.jasonmomanyi.legiontube.data.local.Duration
import io.github.jasonmomanyi.legiontube.data.local.UploadDate
import io.github.jasonmomanyi.legiontube.data.local.SearchFilter
import io.github.jasonmomanyi.legiontube.data.local.SortType
import io.github.jasonmomanyi.legiontube.data.model.Channel
import io.github.jasonmomanyi.legiontube.data.model.Playlist
                ...
                val items: List<SearchResultItem> = infoPage.items.mapNotNull { item ->
                    when (item) {
                        is StreamInfoItem -> {
                            ...
                            if (searchFilter?.contentType == io.github.jasonmomanyi.legiontube.data.local.ContentType.LIVE &&
                                !isLiveStream
                            ) {
