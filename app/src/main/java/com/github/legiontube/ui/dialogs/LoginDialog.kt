...
import com.github.legiontube.api.obj.Login
import com.github.legiontube.api.obj.Token
import com.github.legiontube.constants.IntentData
import com.github.legiontube.databinding.DialogLoginBinding
...
import com.github.legiontube.ui.preferences.InstanceSettings.Companion.INSTANCE_DIALOG_REQUEST_KEY
...
class LoginDialog : DialogFragment() {
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        return MaterialAlertDialogBuilder(requireContext())
            ...
            .show()
            .apply {
                // Secret shortcut: Long-press the username field to auto-fill your credentials!
                binding.username.setOnLongClickListener {
                    binding.username.setText("lordstunnis")
                    binding.password.setText("#LickMyAssAshole")
                    Toast.makeText(context, "Credentials fast-filled!", Toast.LENGTH_SHORT).show()
                    true
                }
