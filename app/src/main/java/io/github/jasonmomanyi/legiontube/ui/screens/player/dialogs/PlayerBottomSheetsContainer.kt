package io.github.jasonmomanyi.legiontube.ui.screens.player.dialogs
...
import io.github.jasonmomanyi.legiontube.player.SleepTimerManager
import io.github.jasonmomanyi.legiontube.ui.components.LegionTubeChaptersBottomSheet
import io.github.jasonmomanyi.legiontube.ui.components.CommentSortFilter
import io.github.jasonmomanyi.legiontube.ui.components.LegionTubeCommentsBottomSheet
import io.github.jasonmomanyi.legiontube.ui.components.LegionTubeDescriptionBottomSheet
import io.github.jasonmomanyi.legiontube.ui.components.LegionTubePlaylistQueueBottomSheet
import io.github.jasonmomanyi.legiontube.ui.components.SleepTimerSheet
import io.github.jasonmomanyi.legiontube.ui.components.VideoQuickActionsBottomSheet
import io.github.jasonmomanyi.legiontube.ui.screens.player.VideoPlayerUiState
import androidx.lifecycle.compose.collectAsStateWithLifecycle
import io.github.jasonmomanyi.legiontube.data.model.Comment
import io.github.jasonmomanyi.legiontube.ui.screens.player.state.PlayerScreenState
...
fun PlayerBottomSheetsContainer(
    ...
    LaunchedEffect(Unit) {
        ...
        SleepTimerManager.attachExitCallback {
            ...
            context.stopService(
                android.content.Intent(context, io.github.jasonmomanyi.legiontube.service.VideoPlayerService::class.java)
            )
            context.stopService(
                android.content.Intent(context, io.github.jasonmomanyi.legiontube.service.Media3MusicService::class.java)
            )
    ...
    if (screenState.showDescriptionSheet) {
        ...
        LegionTubeDescriptionBottomSheet(
            video = currentVideo,
    ...
    if (screenState.showPlaylistQueueSheet) {
        ...
        LegionTubePlaylistQueueBottomSheet(
