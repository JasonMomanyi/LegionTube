...
fun MediaInfoDialog(
    ...
    var mediaInfo by remember { mutableStateOf<io.github.jasonmomanyi.legiontube.innertube.models.MediaInfo?>(null) }
    ...
    LaunchedEffect(track, video) {
        ...
        if (videoId != null) {
            mediaInfo = io.github.jasonmomanyi.legiontube.data.newmusic.InnertubeMusicService.getMediaInfo(videoId)
        }
        isLoading = false
    }
