...
object DatabaseModule {
    ...
    @Provides
    fun provideCacheDao(database: AppDatabase): io.github.jasonmomanyi.legiontube.data.local.dao.CacheDao {
        return database.cacheDao()
    }

    @Provides
    fun provideDownloadDao(database: AppDatabase): io.github.jasonmomanyi.legiontube.data.local.dao.DownloadDao {
