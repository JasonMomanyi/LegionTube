package io.github.jasonmomanyi.legiontube.ui.screens.history
...
class HistoryViewModel : ViewModel() {
    ...
    private fun enrichFromApi(
        ...
        videoDao: io.github.jasonmomanyi.legiontube.data.local.dao.VideoDao,
        watchHistoryDao: io.github.jasonmomanyi.legiontube.data.local.dao.WatchHistoryDao
    ) {
