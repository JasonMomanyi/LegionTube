...
class VideoPlayerService : Service() {
    ...
    companion object {
        ...
        const val ACTION_PLAY_PAUSE = "io.github.jasonmomanyi.legiontube.video.ACTION_PLAY_PAUSE"
        const val ACTION_NEXT = "io.github.jasonmomanyi.legiontube.video.ACTION_NEXT"
        const val ACTION_PREVIOUS = "io.github.jasonmomanyi.legiontube.video.ACTION_PREVIOUS"
        const val ACTION_STOP = "io.github.jasonmomanyi.legiontube.video.ACTION_STOP"
        const val ACTION_CLOSE = "io.github.jasonmomanyi.legiontube.video.ACTION_CLOSE"
